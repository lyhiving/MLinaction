...
if __name__ == "__main__":
	...
	## babydic的id为70
	babydic = {'幼儿教育': '188n2', '亲子游乐': '161n2', '亲子购物': '125n2', '亲子摄影': '193n2', '孕产护理': '258n2', '其它亲子服务': '27769n2'}
	## sportdic的id为45
	...
	## marrydic的id为55
	marrydic = {'婚宴酒店': '165n2', '婚纱礼服': '162n2', '婚纱摄影': '163n2', '婚庆公司': '167n2', '个性写真': '6700n2', '彩妆造型': '166n2',
	            '婚介首饰': '191n2', '婚房装修': '6844n2', '更多婚礼服务': '25410n2'}
	for t in marrydic:
		for i in range(1, 10):
			dp.getDistrictFoodShop('婚庆', t, '55', str('g' + marrydic[t]), str(i))
			# for i in range(1, 50):
